...
func (s *cronService) CheckBalanceHandler() {
	startTime := time.Now()
	var (
		walletBalances []wallet.GetBalanceRes
...
func (s *cronService) checkUserBalance(ctx context.Context, walletBalance wallet.GetBalanceRes) {
...
func (s *cronService) sendUserBalanceAlertTelegram(ctx context.Context, walletBalance wallet.GetBalanceRes, totalCoin string) {
...
func (s *cronService) sendUserBalanceAlertEmail(ctx context.Context, walletBalance wallet.GetBalanceRes, totalCoin string) {
	...
	err = t.Execute(buf, struct {
		WalletBalance wallet.GetBalanceRes
		TotalCoin     string
	}{
...
func (s *cronService) sendReportEmail(ctx context.Context, walletBalances []wallet.GetBalanceRes) {
	...
	walletBalancesFormatted := []wallet.GetBalanceRes{}
	...
	err = t.Execute(buf, struct{ WalletBalances []wallet.GetBalanceRes }{WalletBalances: walletBalancesFormatted})
...
func (s *cronService) sendHotLimitAlertEmail(ctx context.Context, symbol string, walletBalance wallet.GetBalanceRes, limits hl.HotLimit) {
...
func (s *cronService) checkHotLimit(ctx context.Context, currency cc.CurrencyConfig, walletBalance wallet.GetBalanceRes) {
