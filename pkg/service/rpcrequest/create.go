...
func (s *rpcRequestService) Create(ctx context.Context, req domain.RpcRequest) (err error) {
	...
	if err = s.rrqRepo.Create(ctx, req); err != nil {
		err = errs.AssignErr(errs.AddTrace(err), errs.FailedCreateRPCRequest)
		return err
	}
