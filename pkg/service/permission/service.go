...
func NewPermissionService(validator util.CustomValidator, mysqlRepos mysql.MysqlRepositories, exchangeApiRepos exchange.APIRepositories) *permissionService {
