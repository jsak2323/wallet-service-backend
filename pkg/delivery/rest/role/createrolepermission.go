...
func (re *Rest) CreateRolePermissionHandler(w http.ResponseWriter, req *http.Request) {
	var (
		rpReq roleHandler.RolePermissionReq
	...
	service := re.svc.Role
	if err = service.CreateRolePermission(ctx, rpReq); err != nil {
