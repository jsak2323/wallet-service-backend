...
import (
	...
	"github.com/btcid/wallet-services-backend-go/pkg/http/handlers/deposit"
...
func (re *Rest) ListHandler(w http.ResponseWriter, req *http.Request) {
	...
	service := re.svc.Deposit
	if RES.Deposits, err = service.List(ctx, page, limit, filters); err != nil {
