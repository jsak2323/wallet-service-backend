...
import (
	...
	withdrawHandler "github.com/btcid/wallet-services-backend-go/pkg/http/handlers/withdraw"
...
func (re *Rest) ListHandler(w http.ResponseWriter, req *http.Request) {
	...
	service := re.svc.Withdraw
	if RES.Withdraws, err = service.List(ctx, page, limit, filters); err != nil {
