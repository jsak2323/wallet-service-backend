...
func (gts *GeneralTokenMapService) GetNewAddress(rpcConfig rc.RpcConfig, addressType string) (res *model.GetNewAddressRpcRes, err error) {
	...
	args, err := gts.getNewAddressArgs(rpcConfig, rpcMethod, addressType)
	if err != nil {
		return &model.GetNewAddressRpcRes{}, err
	}
...
func (gts *GeneralTokenMapService) getNewAddressArgs(rpcConfig rc.RpcConfig, rpcMethod rm.RpcMethod, addresstype string) (args []string, err error) {
